...
const sortByChildren = (charArray) => {
  ...
  charArray.sort((a, b) => {
    if (a.children.length === b.children.length) {
      return a.house.localeCompare(b.house); // Sort alphabetically by house name if the number of children is the same
    }
    return a.children.length - b.children.length; // Sort by the number of children
  });
